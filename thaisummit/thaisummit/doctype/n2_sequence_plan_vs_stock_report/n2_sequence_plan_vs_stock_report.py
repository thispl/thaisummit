...
class N2SequencePlanvsStockReport(Document):
    @frappe.whitelist()
    def get_html_data(self):
        ...
        d3 = d3.strftime('%d/%m')
        d4 = datetime.strptime(add_days(dates[2],1),'%Y-%m-%d')
        d4 = d4.strftime('%d/%m')
        d5 = datetime.strptime(add_days(dates[2],2),'%Y-%m-%d')
        d5 = d5.strftime('%d/%m')
        header += "<tr><td style='border: 1px solid black;padding:1px;text-align: center;'><b style='text-align: center;'>MAT NO</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>PART NO</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>PART NAME</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>DAILY ORDER</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>%s</b></td><td style='border: 1px solid black;padding: 0px;text-align: center;'><b>%s</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>%s</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>TOTAL PLAN</b></td><td style='border: 1px solid black;padding:1px';text-align: center;><b>FG</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>WELD</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>HPS</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>TOTAL STOCK</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>COVERAGE</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>SHORT</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>PROD PLAN</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>STATUS</b></td><td style='border: 1px solid black;padding:1px;text-align:center;'><b>%s</b></td><td style='border: 1px solid black;padding:1px;text-align:center;'><b>%s</b></td></tr>"%(d1,d2,d3,d4,d5)
...
def get_data(from_date,to_date):
    ...
    for m in master:
        ...
        if daily_order > 0:
            row += "<td style='border: 1px solid black;padding:2px;'>%s</td>"%round(daily_order/days)
        else:
            row += "<td style='border: 1px solid black;padding:2px;'>0</td>"
        row += qty_list
        row += "<td style='border: 1px solid black;padding:2px;'>%s</td>"%round(daily_order)
