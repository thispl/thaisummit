...
class N1SequencePlanvsStockReport(Document):
    @frappe.whitelist()
    def get_html_data(self):
        ...
        header = "<table class='table tabe-bordered'><tr><td colspan='4' style='background-color:#FEF701;border: 1px solid black;font-size:18px;padding:0px'><center><b>N-1 SEQUENCE PLAN VS STOCK REPORT</b></center></td><td colspan='3' style='background-color:#FA8072;border: 1px solid black;font-size:18px;padding:0px'><center><b>DELIVERY PLAN</b></center></td><td colspan='5' style='background-color:#52c132;border: 1px solid black;font-size:18px;padding:0px'><center><b>STOCK</b></center></td><td colspan='3' style='border: 1px solid black;font-size:18px;padding:0px'><center><b>%s</b></center></td></tr>"%today()

        d1 = datetime.strptime(dates[0],'%Y-%m-%d')
        d1 = d1.strftime('%d/%m')
        d2 = datetime.strptime(dates[1],'%Y-%m-%d')
        d2 = d2.strftime('%d/%m')
        header += "<tr><td style='border: 1px solid black;padding:1px;text-align: center;'><b style='text-align: center;'>MAT NO</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>PART NO</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>PART NAME</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>DAILY ORDER</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>%s</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>%s</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>TOTAL PLAN</b></td><td style='border: 1px solid black;padding:1px';text-align: center;><b>FG</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>WELD</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>HPS</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>TOTAL STOCK</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>COVERAGE</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>SHORT</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>PROD PLAN</b></td><td style='border: 1px solid black;padding:1px;text-align: center;'><b>STATUS</b></td></tr>"%(d1,d2)
...
def get_data(from_date,to_date):
    ...
    for m in master:
        ...
        if daily_order > 0:
            row += "<td style='border: 1px solid black;padding:2px;'>%s</td>"%(daily_order/days)
        else:
