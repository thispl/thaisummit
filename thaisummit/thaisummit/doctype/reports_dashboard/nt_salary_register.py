...
def title1(args):
    ...
    data = ["TSAI NT  Wages for the Month of Sep-2021",'','','','','','','','','Standard Structure Month','','','',
...
def get_data(args):
    ...
    if args.employee:
        salary_slips = frappe.get_all("Salary Slip",{'employee_type':'NT','employee':args.employee,'start_date':args.from_date,'end_date':args.to_date},['*'])	
    
    else:
        salary_slips = frappe.get_all("Salary Slip",{'employee_type':'NT','start_date':args.from_date,'end_date':args.to_date},['*'])	
    i =1
