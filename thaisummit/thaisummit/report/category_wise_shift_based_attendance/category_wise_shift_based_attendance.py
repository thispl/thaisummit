...
# from thaisummit.thaisummit.doctype.attendance_dashboard.attendance_dashboard import check_holiday
...
#     _("1M") + ":Data/:70",
#     _("2M") + ":Data/:70",
#     _("3M") + ":Data/:70",_("MM") + ":Data/:70",_("M1") + ":Data/:70",_("M2") + ":Data/:70",_("M3") + ":Data/:70",_("MPP2") + ":Data/:70",_("AA") + ":Data/:70",_("CO") + ":Data/:70",_("WW") + ":Data/:70",_("1W") + ":Data/:70",_("2W") + ":Data/:70",_("3W") + ":Data/:70",_("PP2W") + ":Data/:70",_("HH") + ":Data/:70",_("1H") + ":Data/:70",_("2H") + ":Data/:70",_("3H") + ":Data/:70",_("PP2H") + ":Data/:70",_("OD") + ":Data/:70",_("CL") + ":Data/:70",_("EL") + ":Data/:70",_("SL") + ":Data/:70",_("SPL") + ":Data/:70",_("LA") + ":Data/:70",_("LOP") + ":Data/:70",_("Total") + ":Data/:80",_("Payable") + ":Data/:80",_("Shift Allowance") + ":Data/:120",
#     _("Transport Allowance") + ":Data/:150",
#     _("OT Hours") + ":Data/:100",
...
#     emp = frappe.get_all('Employee',{'status':'Active','vacant':0,'employee_type':filters.employee_type},['department','employee_number','employee_name','date_of_joining','designation','boarding_non_boarding','basic'])
...
#             if filters.employee_type == "WC":
#                 days = add_days(i.date_of_joining,30)
#                 month_end = add_days(get_first_day(filters.to_date),24)
#                 if days <= month_end:
#                     transport = frappe.db.get_value('Designation',i.designation,'transport_allowance')
#                 else:
#                     transport = (count_11+count_22+count_33+count_1l1+count_2l2+count_3l3+count_pp1+count_pp2+count_od+count_1w+count_2w+count_3w+count_pp2w+count_1h+count_2h+count_3h+count_pp2h) * 120
#             else:
#                 transport = (count_11+count_22+count_33+count_1l1+count_2l2+count_3l3+count_pp1+count_pp2+count_od+count_1w+count_2w+count_3w+count_pp2w+count_1h+count_2h+count_3h+count_pp2h) * 120
#         else:
#             transport = 0
...
#         if filters.employee_type == "WC":
#             payable = count_11+count_22+count_33+count_1l1+count_2l2+count_3l3+count_pp1+count_pp2+count_co+count_ww+count_1w+count_2w+count_3w+count_pp2w+count_hh+count_1h+count_2h+count_3h+count_pp2h+count_od+count_cl+count_el+count_sl+count_spl
#         else:
#             payable = count_11+count_22+count_33+count_1l1+count_2l2+count_3l3+count_pp1+count_pp2+count_co+count_hh+count_1h+count_2h+count_3h+count_pp2h+count_od+count_cl+count_el+count_sl+count_spl
        

#         shift_allowance = shift_2 * 10 + shift_3 * 15 + count_2w * 10 + count_3w * 15

#         row = [i.employee_number,i.employee_name,i.department,i.date_of_joining,count_11,count_22,count_33,count_12,count_13,count_21,count_23,count_31,count_32,count_1l1,count_2l2,count_3l3,count_1l2,count_1l3,count_2l1,count_2l3,count_3l1,count_3l2,count_pp1,count_pp2,count_pp1l,count_pp2l,count_1m,count_2m,count_3m,count_mm,count_m1,count_m2,count_m3,count_mpp2,count_aa,count_co,count_ww,count_1w,count_2w,count_3w,count_pp2w,count_hh,count_1h,count_2h,count_3h,count_pp2h,count_od,count_cl,count_el,count_sl,count_spl,count_la,count_lop,total,payable,shift_allowance,transport,total_ot_hr,floor(ot_amount)]
#         data.append(row)
#     return data
