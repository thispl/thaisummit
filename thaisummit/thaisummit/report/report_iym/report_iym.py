...
def get_tag_list():
    ...
    for do in dos[:-1]:
        ...
        if man_qty <= 0:
            if no_man <= 0:
                updated_tbs_dict['today_qty_after_adj'] = 0
            elif no_man > 0:    
                updated_tbs_dict['today_qty_after_adj'] = no_man
        elif man_qty > 0:
            if no_man <= 0:
                updated_tbs_dict['today_qty_after_adj'] = 0
            elif no_man > 0:    
                updated_tbs_dict['today_qty_after_adj'] = tody_qty
        updated_tbs_dict['total_qty'] = updated_tbs_dict['today_qty_after_adj'] + updated_tbs_dict['pending_qty']
        ...
        # if updated_tbs_dict['today_qty'] <= 0:
        #     updated_tbs_dict['today_qty_after_adj'] = 0
        # else:
        #     updated_tbs_dict['today_qty_after_adj'] = tody_qty
        ...
        if updated_tbs_dict['today_qty_after_adj'] > 0:
            updated_tbs_dict['mat_number'] = mat_number
            updated_tbs_dict['qty_today'] = updated_tbs_dict['today_qty_after_adj']
