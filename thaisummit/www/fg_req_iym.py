...
def get_tag_list():
    ...
    total_tbs = frappe.db.sql("""select * from `tabTSAI Part Master` where mat_no like '10%' """,as_dict=1)
    updated_tbs_list = []
    updated_tbs_dict = {}
    ...
    for tbs in total_tbs:
        ...
        if daily_order > 0:
            ...
            updated_tbs_dict['openqty'] = round(get_open_production_qty(tbs['mat_no']))
